const REPO_OWNER = "SOMNATH0904";
const REPO_NAME = "DevSphere";
...
function generateCertificate(username, avatarUrl) {
  ...
  image.onload = () => {
    ...
    contribution to DEVSHPERE in Social Winter of Code (SWoC) 
    ...
    ctx.fillText("SOMNATH0904", canvas.width / 1.5, 850);
    ctx.strokeStyle = "#333333"; // Dark gray
    ctx.lineWidth = 2;
    ctx.beginPath();
